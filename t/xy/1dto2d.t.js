...
require('proof')(9, function (deepEqual) {
    var hilbert = require('../..')
    deepEqual(hilbert.d2xy(0, 2), [0, 0])
    deepEqual(hilbert.d2xy(0, 3), [0, 1])
    deepEqual(hilbert.d2xy(4, 2), [2, 0])
    deepEqual(hilbert.d2xy(15, 2), [3, 0])
    deepEqual(hilbert.d2xy(16, 2), [0, 4])
    deepEqual(hilbert.d2xy(63, 2), [7, 0])
    deepEqual(hilbert.d2xy(64, 2), [0, 8])
    deepEqual(hilbert.d2xy(1023, 2), [31, 0])
    deepEqual(hilbert.d2xy(1024, 2), [0, 32])
